    ...
    >
      <div className="bg-card backdrop-blur-md border border-border rounded-xl p-8 shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join theskytrails and start exploring</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative flex items-center justify-center mt-6">
            ...
            <div className="relative px-4 bg-card text-sm text-muted-foreground">Or sign up with</div>
          </div>
